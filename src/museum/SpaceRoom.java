...
public class SpaceRoom {
	public static BranchGroup createSpaceRoom(){
		...
		//Create Sun
		Appearance sunApp = createApp("sun");
		Sphere sun = new Sphere(0.08f, Sphere.GENERATE_NORMALS | Sphere.GENERATE_TEXTURE_COORDS, sunApp);
		...
		roomTr.setTranslation(new Vector3f(-3.0f, 0.0f, -4.0f));
